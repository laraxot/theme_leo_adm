...
<div style="margin-top: 15px;">
    ...
    <div class="w-100" style="font-family: Montserrat, sans-serif;">
        <div class="w-50" style="display: inline-block;font-family: Montserrat, sans-serif;">
            <p class="w-100" style="display: inline-block;font-weight: bold;font-family: Montserrat, sans-serif;"> <?php echo e($information->store_phone_number); ?> <br /></p>
        </div>
        <a href="tel:<?php echo e($information->store_phone_number); ?>">
...
<?php /**PATH C:\TAVOLI\fastorder.laravel\resources\views/layouts/information_page/phone.blade.php ENDPATH**/ ?>