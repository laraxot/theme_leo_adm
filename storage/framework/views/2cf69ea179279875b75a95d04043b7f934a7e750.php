<div class="w-100"
    ...
    <div style="margin-bottom: 30px;">
        <p style="font-family: Montserrat, sans-serif;font-weight: bold;margin-bottom: 6px;">Email</p><input
            type="email" class="w-100" style="border-top-style: none;border-right-style: none;border-left-style: none; background-color: #f8f9fa;"
            placeholder="Email" />
    </div>
    <div>
        <p style="font-family: Montserrat, sans-serif;font-weight: bold;margin-bottom: 6px;">Password</p><input
            type="password" class="w-100"
            style="border-top-style: none;border-right-style: none;border-left-style: none; background-color: #f8f9fa;" placeholder="Password" /><a
            class="link-secondary" href="#" style="text-decoration: none;float: right;padding-top: 8px;">Password
            dimenticata?</a>
    </div>
</div>
<div class="w-100" style="display: inline-block;">
    ...
    <div class="w-50"
        style="display: inline-block;float: right;margin-top: 24px;background: #74b9be;border-radius: 89px;box-shadow: 8px 9px 15px rgb(150,150,150);">
        <h1 class="w-100"
...
<?php /**PATH C:\TAVOLI\fastorder.laravel\resources\views/layouts/login_page/form.blade.php ENDPATH**/ ?>