                ...
                <div style="background: #13849621; padding: 30px; border-radius: 30px;">
                    ...
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <form action="<?php echo e(route('admin.add_product')); ?>" method="POST" style="margin-top: 20px;">
                            ...
                            <?php echo csrf_field(); ?>
                            <input type="text" name="name" placeholder="<?php echo e($product->name); ?>"
                                style="display: inline-block; width: 24%; margin-bottom: 10px; border-radius: 30px; border: none; padding: 8px;">
                            <input type="text" name="guid" placeholder="<?php echo e($product->guid); ?>"
                                style="display: inline-block; width: 24%; margin-bottom: 10px; border-radius: 30px; border: none; padding: 8px;">
                            <br>
                            <input type="text" name="recipes" placeholder="<?php echo e($product->recipes); ?>"
                                style="width: 48.5%; margin-bottom: 10px; border-radius: 30px; border: none; padding: 8px;">
                            <br>
                            <input type="text" name="img" placeholder="<?php echo e($product->img); ?>"
                                style="width: 48.5%; margin-bottom: 10px; border-radius: 30px; border: none; padding: 8px;">
                            <br>
                            <input type="number" step="0.01" name="price" placeholder="<?php echo e($product->price); ?>"
                                style="width: 24%; margin-bottom: 10px; border-radius: 30px; border: none; padding: 8px;">
                            <input type="number" step="0.01" name="maxi_price" placeholder="<?php echo e($product->maxi_price); ?>"
                                style="width: 24%; margin-bottom: 10px; border-radius: 30px; border: none; padding: 8px;">
                            <br>
                            ...
                            <select id="category_guid" name="category_guid"
                                ...
                                <option value="<?php echo e($product->category_guid); ?>"><?php echo e($product->category_guid); ?></option>
                                <?php
                            ...
                            <select id="variant_category_guid" name="variant_category_guid"
                                style="width: 16%; margin-bottom: 10px; border-radius: 30px; border: none; padding: 8px;">
                                <option value="<?php echo e($product->variant_category_guid); ?>"><?php echo e($product->variant_category_guid); ?></option>
                                <?php
                            ...
                            <select id="dough_category_guid" name="dough_category_guid"
                                style="width: 16%; margin-bottom: 10px; border-radius: 30px; border: none; padding: 8px;">
                                <option value="<?php echo e($product->dough_category_guid); ?>"><?php echo e($product->dough_category_guid); ?></option>
                                <?php
...
<?php /**PATH C:\TAVOLI\fastoder.laravel\resources\views/admin/gestione_categorie/modifica_prodotto.blade.php ENDPATH**/ ?>