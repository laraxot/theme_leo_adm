<?php
$categories = DB::select('select * from categories where superior_category_guid != "root"');
?>
...
<?php /**PATH C:\TAVOLI\fastorder.laravel\resources\views/layouts/homepage/category.blade.php ENDPATH**/ ?>