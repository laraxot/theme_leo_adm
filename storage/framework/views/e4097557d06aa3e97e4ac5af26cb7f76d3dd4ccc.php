<?php
$superior_categories = DB::select('select * from categories where superior_category_guid = "root"');
?>
            ...
            <div
                ...
                <button style="border: none; background-color:#F8F9FA;text-align: center" type="button">
                    <div
                        ...
                        <img src="<?php echo e($superior_category->img); ?>"
                ...
                <h6
                    ...
                    <?php echo e($superior_category->name); ?>
...
<?php /**PATH C:\TAVOLI\fastorder.laravel\resources\views/layouts/homepage/slidable.blade.php ENDPATH**/ ?>