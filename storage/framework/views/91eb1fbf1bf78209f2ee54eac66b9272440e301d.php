        ...
        <div class="row">
            ...
            <div id="content">
                ...
                <div style="background: #13849621; padding: 30px; border-radius: 30px;">
                    ...
                    <form action="<?php echo e(route('admin.create_category')); ?>" method="POST" style="margin-top: 20px;">
...
<?php /**PATH C:\TAVOLI\fastoder.laravel\resources\views/admin/gestione_categorie/crea_categoria.blade.php ENDPATH**/ ?>