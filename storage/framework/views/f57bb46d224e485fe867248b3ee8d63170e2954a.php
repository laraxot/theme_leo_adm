    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <a style="color: rgb(43, 43, 43) !important;"
                href="<?php echo e(url('/admin/gestione_categorie/crea_categoria')); ?>">
            ...
            <div style="margin-left: -20px;">
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div
                        ...
                        <a href="<?php echo e(url('/admin/gestione_categorie/' . $category->guid)); ?>">
                            <img style="width: 240px;height: 151px;margin: 0px;margin-top: 3px;border-radius: 11px;margin-right: 0px;"
                                src="<?php echo e($category->img); ?>" />
                        </a>
                        <a href="<?php echo e(url('/' . $category->guid)); ?>" style="color: rgb(31, 30, 30) !important;">
                            <h1
...
<?php /**PATH C:\TAVOLI\fastoder.laravel\resources\views/admin/gestione_categorie/dashboard.blade.php ENDPATH**/ ?>