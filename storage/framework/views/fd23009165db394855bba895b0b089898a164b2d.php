        <nav class="navbar navbar-light navbar-expand-md fixed-top navigation-clean"
            ...
            <div class="container"><a href="<?php echo e(url('/')); ?>"><img
                        src="https://firebasestorage.googleapis.com/v0/b/fastorderlaravel.appspot.com/o/Image%2FLogo%2Flogo.png?alt=media&token=20f0fed2-8bea-4354-a38d-27194c797092"
                ...
                <div style="float: right;float: right;width: 130.297px;height: 38px;">
                    ...
                    <a href="<?php echo e(url('/information')); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                            viewBox="0 0 16 16" fill="currentColor" class="bi bi-info-circle"
...
<?php /**PATH C:\TAVOLI\fastorder.laravel\resources\views/layouts/global/topbar.blade.php ENDPATH**/ ?>