...
@php
    $additions = DB::select('select * from products where category_guid = (SELECT variant_category_guid FROM products WHERE guid ="' . $guid . '") AND store_id = 1')
@endphp
                            ...
                            <div class="addition_item"
                                ...
                                <div style="display: inline-block; text-align: right">
                                    <h5
                                        ...
                                        <span>€ </span><span
                                            class="prz_addition">{{ number_format($addition->price,2,',','') }}</span>
                                    </h5>
                                </div>
                            </div>
...
@php
    $doughs = DB::select('select * from products where category_guid = (SELECT dough_category_guid FROM products WHERE guid ="' . $guid . '") AND store_id = 1')
@endphp
                            ...
                            <div class="addition_item"
                                ...
                                <div style="display: inline-block; text-align: right">
                                    <h5
                                        style="display: inline-block;text-align: right;color: rgb(128,128,128);font-family: Montserrat, sans-serif;font-size: 18px">
                                        <span>€ </span><span
                                            class="prz_addition">{{ number_format($dough->price,2,',','') }}</span>
                                    </h5>
                                </div>
                            </div>
