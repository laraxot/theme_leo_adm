<div class="w-100">
    <a href="{{ url('profile/personal_data') }}" style="text-decoration: none;">
    ...
    <a href="{{ url('profile/change_password') }}" style="text-decoration: none;">
        <p style="margin-top: 10px;color: rgb(98,105,113);font-family: Montserrat, sans-serif;font-size: 15px;">
    ...
    <a href="{{ url('profile/address') }}" style="text-decoration: none;">
        <p style="margin-top: 10px;color: rgb(98,105,113);font-family: Montserrat, sans-serif;font-size: 15px;">
