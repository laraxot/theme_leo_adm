                    ...
                    <form enctype="multipart/form-data">
                        <div style="text-align: center; justify-content: center; align-items: center;">
                            ...
                            display: flex; align-items: center; justify-content: center; flex-direction: column;">
                                ...
                                <br>
                                <button type="button" onclick="upload()" style="cursor: pointer; margin-top: -20px; padding: 10px 25px; font-size: 16px; 
                                            font-weight: 500; border: none; outline: none; background: rgb(51, 51, 51);
                                            border-radius: 5px; color: white">
                                    Caricare un file
                                </button>
                                <input type="file" id="image" accept="image/*t" hidden>
                            </div>
                        </div>
                    </form>

                    <form action="{{ route('admin.add_product') }}" method="POST" style="margin-top: 20px;">
                        ...
                        <input type="text" name="name" placeholder="Nome Prodotto" oninput="assignGuid(this)"
                            style="display: inline-block; width: 24%; margin-bottom: 10px; border-radius: 30px; border: none; padding: 8px;">
                        
                        <input type="text" name="guid" placeholder="GUID" id="guid"
                            style="display: inline-block; width: 24%; margin-bottom: 10px; border-radius: 30px; border: none; padding: 8px;">
                        <br>
                        ...
                        <input type="number" step="0.01" name="maxi_price" placeholder="Prezzo Maxi"
                            style="width: 24%; margin-bottom: 10px; border-radius: 30px; border: none; padding: 8px;">
                        <br>
                        {{-- <inputtype="number"name="reduction_price"placeholder=""> --}}
                        ...
                        <label for="department" style="margin-left: 17%">Reparto:</label> <br>

                        <input type="number" step="0.01" value="10" name="iva"
                            placeholder="Percentuale IVA (Default 10)"
                            style="width: 24%; margin-bottom: 10px; border-radius: 30px; border: none; padding: 8px;">
                        <input type="string" step="0.01" value="01" name="department" placeholder="Reparto (Default 01)"
                            style="width: 24%; margin-bottom: 10px; border-radius: 30px; border: none; padding: 8px;">
