    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <a style="color: rgb(43, 43, 43) !important;"
                href="{{ url('/admin/gestione_categorie/aggiungi_prodotto/' . $guid) }}">
                ...
                @foreach ($products as $product)
                    ...
                    <div
                        ...
                        <img style="width: 240px;height: 151px;margin: 0px;margin-top: 3px;border-radius: 11px;margin-right: 0px;"
                            src="{{ $product->img }}" />
                        <a href="{{ url('/admin/modifica_prodotto/'. $product->guid) }}" style="color: rgb(31, 30, 30) !important;">
                            <h1
                                style="cursor: pointer; font-size: 18px;text-align: left;margin-top: 8px;
                                margin_bottom: 20px; margin-left: 5px;font-family: Montserrat, sans-serif;">
                        ...
                        <a href="{{ url('/admin/elimina_prodotto/' . $product->guid . '/' . $guid) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
