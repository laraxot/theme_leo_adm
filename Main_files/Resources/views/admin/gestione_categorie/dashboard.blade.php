            ...
            <div style="margin-left: -20px;">
                ...
                @foreach ($categories as $category)
                    ...
                    <div
                        ...
                        <a href="{{ url('/admin/gestione_categorie/' . $category->guid) }}">
                            <img style="width: 240px;height: 151px;margin: 0px;margin-top: 3px;border-radius: 11px;margin-right: 0px;"
                                src="{{ $category->img }}" />
                        </a>
                        <a href="{{ url('/admin/modifica_categoria/' . $category->guid) }}" style="color: rgb(31, 30, 30) !important;">
                            <h1
                                style="cursor: pointer; font-size: 18px;text-align: left;margin-top: 8px;margin-left: 5px;
                        ...
                        <a href= {{ url('/admin/elimina_categoria/' . $category->guid) }}>
